        ...
        <div class="p-6">
            ...
            <div class="text-center">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('settings.profile.edit') }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-md transition-colors">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
