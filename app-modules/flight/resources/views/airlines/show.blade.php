        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin-dashboard.flight.airlines.edit', $airline->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-yellow-600 border border-transparent rounded-md hover:bg-yellow-700">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <a href="{{ route('admin-dashboard.flight.flights.index') }}?airline_id={{ $airline->id }}" class="text-xs text-blue-600 hover:text-blue-800">View All</a>
                                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('admin-dashboard.flight.flights.create') }}?airline_id={{ $airline->id }}" class="block w-full text-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700">
                                Add Flight
                            </a>
