        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="flex bg-gray-50 border-b">
                    ...
                    <a href="{{ route('hotel::dynamic.index') }}" class="flex-1 flex items-center justify-center py-4 px-6 text-gray-500 hover:text-gray-700 transition-colors">
