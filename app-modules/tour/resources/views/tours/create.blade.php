    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Create Tour</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Add a new tour to the system</p>
                </div>
        ...
        <div class="p-6">
            <form action="{{ route('admin-dashboard.tour.tours.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                @csrf
                        ...
                        <div>
                            ...
                            <select id="tour_type"
                                ...
                                @foreach($tourTypes as $key => $label)
                                    <option value="{{ $key }}" {{ old('tour_type') == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('admin-dashboard.tour.tours.index') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600">
                        Cancel
                    </a>
