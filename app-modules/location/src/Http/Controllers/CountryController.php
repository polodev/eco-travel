...
class CountryController extends Controller
{
    ...
    {
        $model = Country::withCount(['cities', 'airports']);
        ...
        return DataTables::eloquent($model)
            ...
            ->addColumn('action', function (Country $country) {
                ...
                $actions .= '<a href="' . route('admin-dashboard.location.countries.show', $country->id) . '" class="inline-flex items-center px-2.5 py-1.5 text-xs font-medium rounded text-white bg-blue-600 hover:bg-blue-700 transition-colors" title="View">
                ...
                $actions .= '<a href="' . route('admin-dashboard.location.countries.edit', $country->id) . '" class="inline-flex items-center px-2.5 py-1.5 text-xs font-medium rounded text-white bg-yellow-600 hover:bg-yellow-700 transition-colors" title="Edit">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-dashboard.location.countries.index')
    ...
    public function update(Request $request, Country $country)
    {
        ...
        return redirect()->route('admin-dashboard.location.countries.show', $country->id)
