...
class AirportController extends Controller
{
    ...
    public function indexJson(Request $request)
    {
        ...
        return DataTables::eloquent($model)
            ...
            ->addColumn('action', function (Airport $airport) {
                ...
                $actions .= '<a href="' . route('admin-dashboard.location.airports.show', $airport->id) . '" class="inline-flex items-center px-2.5 py-1.5 text-xs font-medium rounded text-white bg-blue-600 hover:bg-blue-700 transition-colors" title="View">
                ...
                $actions .= '<a href="' . route('admin-dashboard.location.airports.edit', $airport->id) . '" class="inline-flex items-center px-2.5 py-1.5 text-xs font-medium rounded text-white bg-yellow-600 hover:bg-yellow-700 transition-colors" title="Edit">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-dashboard.location.airports.index')
    ...
    public function update(Request $request, Airport $airport)
    {
        ...
        return redirect()->route('admin-dashboard.location.airports.show', $airport->id)
