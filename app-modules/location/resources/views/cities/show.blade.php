            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="{{ route('location::admin.airports.index') }}?city_id={{ $city->id }}" class="text-xs text-blue-600 hover:text-blue-800">View All</a>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('location::admin.airports.create') }}?city_id={{ $city->id }}" class="block w-full text-center px-3 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700">
                                Add Airport
                            </a>
