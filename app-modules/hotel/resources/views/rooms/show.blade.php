        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin-dashboard.hotel.rooms.edit', $room) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-yellow-600 border border-transparent rounded-md hover:bg-yellow-700">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="{{ route('admin-dashboard.hotel.rooms.create', ['hotel_id' => $room->hotel_id]) }}" 
                            ...
                            <a href="{{ route('admin-dashboard.hotel.hotels.show', $room->hotel) }}" 
                               class="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md hover:bg-gray-50 dark:hover:bg-gray-500">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
