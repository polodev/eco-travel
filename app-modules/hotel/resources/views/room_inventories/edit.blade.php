    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Room Inventory</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Update room inventory record</p>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin-dashboard.hotel.room-inventories.show', $roomInventory) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-md hover:bg-blue-100 dark:hover:bg-blue-800">
        ...
        <div class="p-6">
            <form action="{{ route('admin-dashboard.hotel.room-inventories.update', $roomInventory) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="hotel_room_id"
                                ...
                                @foreach($hotelRooms as $room)
                                    <option value="{{ $room->id }}" {{ old('hotel_room_id', $roomInventory->hotel_room_id) == $room->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   id="date"
                                   name="date"
                                   value="{{ old('date', $roomInventory->date->toDateString()) }}"
                        ...
                        <div>
                            ...
                            <select id="rate_plan"
                                ...
                                @foreach(\Modules\Hotel\Models\RoomInventory::getAvailableRatePlans() as $key => $label)
                                    <option value="{{ $key }}" {{ old('rate_plan', $roomInventory->rate_plan) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="total_rooms"
                                   name="total_rooms"
                                   value="{{ old('total_rooms', $roomInventory->total_rooms) }}"
                                   min="1"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
                            @error('total_rooms')
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('available_rooms', $roomInventory->available_rooms) }}"
                                   min="0"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="booked_rooms"
                                   name="booked_rooms"
                                   value="{{ old('booked_rooms', $roomInventory->booked_rooms) }}"
                                   min="0"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('booked_rooms')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="blocked_rooms"
                                   name="blocked_rooms"
                                   value="{{ old('blocked_rooms', $roomInventory->blocked_rooms) }}"
                                   min="0"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('blocked_rooms')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="price"
                                   name="price"
                                   value="{{ old('price', $roomInventory->price) }}"
                                   min="0"
                                   step="0.01"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="0.00"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('discount_percentage', $roomInventory->discount_percentage) }}"
                                   min="0"
                                   max="100"
                                   step="0.01"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="final_price"
                                   name="final_price"
                                   value="{{ old('final_price', $roomInventory->final_price) }}"
                                   min="0"
                                   step="0.01"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="0.00"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="minimum_stay"
                                   name="minimum_stay"
                                   value="{{ old('minimum_stay', $roomInventory->minimum_stay) }}"
                                   min="1"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('minimum_stay')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="maximum_stay"
                                   name="maximum_stay"
                                   value="{{ old('maximum_stay', $roomInventory->maximum_stay) }}"
                                   min="1"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('maximum_stay')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        @foreach(\Modules\Hotel\Models\RoomInventory::getAvailableInclusions() as $key => $label)
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       name="inclusions[]"
                                       value="{{ $key }}"
                                       {{ in_array($key, old('inclusions', $roomInventory->inclusions ?? [])) ? 'checked' : '' }}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   name="is_available"
                                   value="1"
                                   {{ old('is_available', $roomInventory->is_available) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   name="stop_sell"
                                   value="1"
                                   {{ old('stop_sell', $roomInventory->stop_sell) ? 'checked' : '' }}
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea id="notes"
                                  ...
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Optional notes about this inventory record">{{ old('notes', $roomInventory->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('admin-dashboard.hotel.room-inventories.show', $roomInventory) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600">
                        Cancel
                    </a>
