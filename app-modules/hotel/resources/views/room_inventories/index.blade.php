<x-admin-dashboard-layout::layout>
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('hotel::admin.room-inventories.create') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @push('scripts')
    <script>
        const current_route_name = 'hotel::admin.room-inventories.index';
        ...
        $(document).ready(function() {
            ...
            var inventoriesTable = $('#inventories-table').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{{ route('hotel::admin.room-inventories.json') }}'
                    type: "POST",
                    data: function(d) {
