                    ...
                    <div>
                        ...
                        <select id="payment_method" name="payment_method"
                            ...
                            @foreach($orderedMethods as $value => $label)
                                <option value="{{ $value }}" {{ old('payment_method', 'sslcommerz') === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                <p>A payment record will be automatically created with the specified amount and selected payment method (or SSLCommerz if none selected). You can modify the payment details later in the payment management section.</p>
                            </div>
                        </div>
                    </div>
                </div>
