            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('booking::admin.booking-hotels.index') }}" 
                        ...
                        <a href="{{ route('booking::admin.bookings.show', $bookingHotel->booking) }}" 
                        ...
                        @if(in_array($bookingHotel->booking_status, ['pending', 'confirmed']))
                            <a href="{{ route('booking::admin.booking-hotels.edit', $bookingHotel) }}" 
                ...
                .then(data => {
                    if (data.success) {
                        if (data.redirect) {
                            ...
                            window.location.href = '{{ route("booking::admin.booking-hotels.index") }}';
                        }
                    } else {
