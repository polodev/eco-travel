...
new class extends Component {
    ...
    {
        $this->booking = $booking->load('payments');
        $this->calculateRemainingAmount();
    }

    protected $listeners = ['discountUpdated' => 'refreshBooking'];
    ...
    public function calculateRemainingAmount()
    {
        if (!$this->isEditing) {
            ...
            $remaining = $this->booking->net_receivable_amount - $totalPaid;
    ...
    public function openEditModal(Payment $payment)
    {
    ...
    {
        return $this->booking->payments->where('status', 'completed')->sum('amount');
    }

    public function getRemainingAmount()
    {
        return $this->booking->net_receivable_amount - $this->getTotalPaidAmount();
    }
}; ?>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    ...
                    <div class="text-2xl font-bold text-blue-900 dark:text-blue-100">৳{{ number_format($booking->net_receivable_amount, 2) }}</div>
                </div>
                            ...
                            <form wire:submit="savePayment" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="receipt_number" id="receipt_number"
                                           class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-blue-500 focus:border-blue-500 @error('receipt_number') border-red-500 @enderror">
