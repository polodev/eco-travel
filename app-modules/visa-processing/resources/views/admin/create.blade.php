<x-admin-dashboard-layout::layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Visa Processing</h1>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new visa processing service</p>
                    </div>
                </div>
            </div>

            <!-- Form -->
            <form action="{{ route('visa-processing::admin.visa-processings.store') }}" method="POST" class="space-y-6">
                @csrf
                            ...
                            <div>
                                ...
                                <select name="country" id="country" 
                                    ...
                                    @foreach(\Modules\VisaProcessing\Models\VisaProcessing::getCountries() as $key => $country)
                                        <option value="{{ $key }}" {{ old('country') == $key ? 'selected' : '' }}>{{ $country['flag'] }} {{ $country['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('country')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="estimated_processing_time" id="estimated_processing_time" min="1"
                                       value="{{ old('estimated_processing_time') }}"
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="content[en]" id="content_en" rows="15"
                                              ...
                                              placeholder="Detailed visa requirements and procedures in English" required>{{ old('content.en') }}</textarea>
                                    @error('content.en')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="content[bn]" id="content_bn" rows="15"
                                              ...
                                              placeholder="বিস্তারিত ভিসার প্রয়োজনীয়তা এবং পদ্ধতি বাংলায়">{{ old('content.bn') }}</textarea>
                                    @error('content.bn')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="meta_description[en]" id="meta_description_en" rows="3"
                                              class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                              placeholder="SEO meta description (150-160 characters)">{{ old('meta_description.en') }}</textarea>
                                </div>
                                <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="meta_description[bn]" id="meta_description_bn" rows="3"
                                              class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                              placeholder="SEO মেটা বিবরণ (150-160 অক্ষর)">{{ old('meta_description.bn') }}</textarea>
                                </div>
                                <div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Auto-fill slug from English title
            $('#english_title').on('input', function() {
